<template>
  <div id="app">
    <MazSidebar
      ...
      class="navigation"
    >
      <router-link to="/" class="d-flex justify-content-center mt-2">
      ...
      <div>
        <div class="navigation__menu-item d-flex align-items-center px-3 py-2" @click="setCollapseItem('endpoints')">
          <span class="material-icons mr-2 navigation__menu-icon" :class="{'navigation__menu-icon--open': activeCollapse.includes('models')}">
            arrow_right
          </span>
          Endpoints
        </div>
        <MazTransitionExpand>
          <div v-show="activeCollapse.includes('endpoints')">
            <router-link v-for="(value, propertyName) in endpoints" :key="propertyName" :to="'/endpoints/' + propertyName" class="navigation__menu-item navigation__menu-item--sub d-flex align-items-center pr-3 pl-6 py-2">
      ...
      <div>
        <div class="navigation__menu-item d-flex align-items-center px-3 py-2" @click="setCollapseItem('models')">
          <span class="material-icons mr-2 navigation__menu-icon" :class="{'navigation__menu-icon--open': activeCollapse.includes('models')}">
            arrow_right
          </span>
          Models
        ...
        <MazTransitionExpand>
          <div v-show="activeCollapse.includes('models')">
            <router-link v-for="(value, propertyName) in endpoints" :key="propertyName" :to="'/models/' + propertyName" class="navigation__menu-item navigation__menu-item--sub d-flex align-items-center pr-3 pl-6 py-2">
              <span class="material-icons mr-2">
                model_training
              </span>
              <span>{{ propertyName }}</span>
